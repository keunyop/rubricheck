  ...
  if (plan === "pro") {
    return (
      ...
      >
        ...
        <span className="inline-flex items-center gap-1 rounded-full bg-white/85 px-2.5 py-1 text-[11px] font-semibold text-slate-800 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)]">
          <span className="text-[14px] leading-none text-cyan-700">∞</span>
